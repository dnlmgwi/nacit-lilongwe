...
export const HeroBlock: React.FC<HeroBlockProps> = ({
  ...
  return (
    <div
      className={cn(
        'w-full h-[900px] overflow-hidden pt-4',
        bgColorClasses[backgroundColor as keyof typeof bgColorClasses],
      )}
    >
      <div className="flex w-full items-center justify-center pt-">
      ...
      <div className="container py-4 md:py-24 flex flex-col md:flex-col items-center gap-8 md:gap-16">
