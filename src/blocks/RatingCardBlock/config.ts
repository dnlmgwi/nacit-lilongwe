...
export const RatingBlock: Block = {
  ...
  fields: [
    ...
    {
      name: 'showRatingComponent',
      type: 'checkbox',
      label: 'Show Rating Component',
      defaultValue: false,
      admin: {
        description: 'Toggle to show or hide the rating component',
      },
    },
    {
      ...
      admin: {
        description: 'Add a rating Component',
        condition: (_, { showRatingComponent } = {}) => showRatingComponent === true,
      },
      fields: [
        {
